...
function parseFollowing(json) {
  const list = json && json.Activity && json.Activity.Following && json.Activity.Following.Following;
  if (!Array.isArray(list)) {
    throw new Error("Khong tim thay Activity.Following.Following trong file.");
  }
  return list
